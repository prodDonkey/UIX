...
| ID | 任务 | 优先级 | 预计工时 | 依赖 | 产出物 | 验收标准 | 状态 |
|---|---|---|---:|---|---|---|---|
| M3-BE-01 | LLM Provider 适配层 | P0 | 1d | M1-BE-01 | `llm_service.py` | 可调用目标模型接口 | TODO |
| M3-BE-02 | 自然语言生成 YAML API | P0 | 1d | M3-BE-01 | `/api/scripts/generate` | 返回可解析 YAML 或明确错误 | TODO |
| M3-BE-03 | 生成结果二次校验 | P0 | 0.5d | M3-BE-02 | 生成后校验流程 | 不合法 YAML 不允许入库 | TODO |
| M3-BE-04 | 报告预览/下载接口 | P0 | 0.5d | M2-BE-05 | `/api/runs/{id}/report` | 直接复用 Midscene HTML 报告 | TODO |
| M3-BE-05 | 路径白名单与安全校验 | P0 | 0.5d | M3-BE-04 | 报告目录访问限制 | 防止路径穿越 | TODO |
| M3-FE-01 | AI 生成面板与交互 | P0 | 1d | M3-BE-02 | `AiGeneratePanel.vue` | 输入描述后可回填编辑器 | TODO |
| M3-FE-02 | 报告 iframe 预览 | P0 | 0.5d | M3-BE-04 | 报告预览区 | 可在页面查看 HTML 报告 | TODO |
| M3-FE-03 | 报告下载功能 | P1 | 0.5d | M3-BE-04 | 下载按钮 | 可下载原始报告文件 | TODO |
| M3-QA-01 | M3 回归测试 | P0 | 0.5d | M3 全部 | 测试记录 | AI 生成->执行->报告闭环通过 | TODO |
