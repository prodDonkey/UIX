        ...
        label: (
          <div style={{ padding: '4px 0' }}>
            ...
            >
              ...
              <Radio value={'visible-only'}>仅可见部分</Radio>
            </Radio.Group>
          </div>
        ),
      ...
      items.push({
        label: (
          <div style={{ padding: '4px 0' }}>
            ...
            >
              <Radio value="always-yadb">始终使用 YADB</Radio>
              <Radio value="yadb-for-non-ascii">
                非 ASCII 场景使用 YADB
              </Radio>
            </Radio.Group>
          </div>
      ...
      items.push({
        label: (
          <div style={{ padding: '4px 0' }}>
            ...
            >
              <Radio value="esc-first">优先 ESC</Radio>
              <Radio value="back-first">优先 Back</Radio>
            </Radio.Group>
          </div>
        ),
