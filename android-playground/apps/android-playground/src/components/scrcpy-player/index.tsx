  ...
  (
    ...
    const createDecoder = async (codecId: ScrcpyVideoCodecId) => {
      ...
      if (!WebCodecsVideoDecoder.isSupported) {
        throw new Error(
          '当前浏览器不支持 WebCodecs API，请使用最新版本的 Chrome 或 Edge 浏览器',
        );
      }
          ...
          {connected && (
            <div className="header-bar">
              ...
              <div className="header-right">
                <Tooltip placement="bottom" title="截图">
                ...
                />
                <Tooltip placement="bottom" title="连接设备">
                  <Button
                    disabled={connected}
                    style={{
                      backgroundColor: '#fff',
